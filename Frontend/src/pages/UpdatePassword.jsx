          ...
          <form onSubmit={handleOnSubmit}>
            <label className="relative">
              ...
              <input
                ...
                className="form-style w-full pl-2"
              />
              <span
                onClick={() => setShowPassword((prev) => !prev)}
                className="absolute right-3 top-[27px] z-[10] cursor-pointer"
              >
                {showPassword ? (
                  <AiOutlineEyeInvisible fontSize={24} fill="#AFB2BF" />
                ) : (
                  <AiOutlineEye fontSize={24} fill="#AB2BF" />
                )}
              </span>
            </label>
            <label className="relative mt-3 block">
              ...
              <input
                ...
                className="form-style w-full !pr-10 pl-2"
              />
              <span
